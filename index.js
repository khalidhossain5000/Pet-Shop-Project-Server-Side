...
const uri =
  `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.r4vhlna.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
//user info adding to the db
    ...
    app.post("/users", async (req, res) => {
      try {
        ...
        const existingUser = await usersCollections.findOne({ email: userInfo.email });
        if (existingUser) {
